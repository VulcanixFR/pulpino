...
DECLARE_INSN(p.lbpost,  MATCH_LBPOST,  MASK_LPOST)
DECLARE_INSN(p.lbupost, MATCH_LBUPOST, MASK_LPOST)
DECLARE_INSN(p.lhpost,  MATCH_LHPOST,  MASK_LPOST)
DECLARE_INSN(p.lhupost, MATCH_LHUPOST, MASK_LPOST)
DECLARE_INSN(p.lwpost,  MATCH_LWPOST,  MASK_LPOST)

/* register-register loads */
DECLARE_INSN(p.lbrr,  MATCH_LBRR,  MASK_LRR)
DECLARE_INSN(p.lburr, MATCH_LBURR, MASK_LRR)
DECLARE_INSN(p.lhrr,  MATCH_LHRR,  MASK_LRR)
DECLARE_INSN(p.lhurr, MATCH_LHURR, MASK_LRR)
DECLARE_INSN(p.lwrr,  MATCH_LWRR,  MASK_LRR)

/* register-register post-increment loads */
DECLARE_INSN(p.lbrrpost,  MATCH_LBRRPOST,  MASK_LRRPOST)
DECLARE_INSN(p.lburrpost, MATCH_LBURRPOST, MASK_LRRPOST)
...
DECLARE_INSN(pv.add, MATCH_V_OP_ADD|MATCH_V_OP)
DECLARE_INSN(pv.sub, MATCH_V_OP_SUB|MATCH_V_OP)
DECLARE_INSN(pv.avg, ATCH_V_OP_AVG|MATCH_V_OP)
DECLARE_INSN(pv.avgu, MATCH_V_OP_AVGU|MATCH_V_OP)
DECLARE_INSN(pv.min, MATCH_V_OP_MIN|MATCH_V_OP)
DECLARE_INSN(pv.minu, MATCH_V_OP_MINU|MATCH_V_OP)
DECLARE_INSN(pv.max, MATCH_V_OP_MAX|MATCH_V_OP)
DECLARE_INSN(pv.maxu, MATCH_V_OP_MAXU|MATCH_V_OP)
DECLARE_INSN(pv.srl, MATCH_V_OP_SRL|MATCH_V_OP)
DECLARE_INSN(pv.sra, MATCH_V_OP_SRA|MATCH_V_OP)
DECLARE_INSN(pv.sll, MATCH_V_OP_SLL|MATCH_V_OP)
DECLARE_INSN(pv.or, MATCH_V_OP_OR|MATCH_V_OP)
DECLARE_INSN(pv.xor, MATCH_V_OP_XOR|MATCH_V_OP)
DECLARE_INSN(pv.and, MATCH_V_OP_AND|MATCH_V_OP)
DECLARE_INSN(pv.abs, MATCH_V_OP_ABS|MATCH_V_OP)
DECLARE_INSN(pv.extract, MATCH_V_OP_EXTRACT|MATCH_V_OP)
DECLARE_INSN(pv.extractu, MATCH_V_OP_EXTRACTU|MATCH_V_OP)
DECLARE_INSN(pv.insert, MATCH_V_OP_INSERT|MATCH_V_OP)
DECLARE_INSN(pv.dotsp, MATCH_V_OP_DOTSP|MATCH_V_OP)
DECLARE_INSN(pv.dotup, MATCH_V_OP_DOTUP|MATCH_V_OP)
DECLARE_INSN(pv.dotusp, MATCH_V_OP_DOTUSP|MATCH_V_OP)
DECLARE_INSN(pv.sdotsp, MATCH_V_OP_SDOTSP|MATCH_V_OP)
DECLARE_INSN(pv.sdotup, MATCH_V_OP_SDOTUP|MATCH_V_OP)
DECLARE_INSN(pv.sdotusp, MATCH_V_OP_SDOTUSP|MATCH_V_OP)
DECLARE_INSN(pv.shuffle, MATCH_V_OP_SHUFFLE|MATCH_V_OP)
DECLARE_INSN(pv.shuffle2, MATCH_V_OP_SHUFFLE2|MATCH_V_OP)
DECLARE_INSN(pv.pack, MATCH_V_OP_PACK|MATCH_V_OP)
DECLARE_INSN(pv.packhi, MATCH_V_OP_PACKHI|MATCH_V_OP)
DECLARE_INSN(pv.packlo, MATCH_V_OP_PACKLO|MATCH_V_OP)

DECLARE_INSN(pv.cmpeq, MATCH_V_OP_CMPEQ|MATCH_V_OP)
DECLARE_INSN(pv.cmpne, MATCH_V_OP_CMPNE|MATCH_V_OP)
DECLARE_INSN(pv.cmpgt, MATCH_V_OP_CMPGT|MATCH_V_OP)
DECLARE_INSN(pv.cmpge, MATCH_V_OP_CMPGE|MATCH_V_OP)
DECLARE_INSN(pv.cmplt, MATCH_V_OP_CMPLT|MATCH_V_OP)
DECLARE_INSN(pv.cmple, MATCH_V_OP_CMPLE|MATCH_V_OP)
DECLARE_INSN(pv.cmpgtu, MATCH_V_OP_CMPGTU|MATCH_V_OP)
DECLARE_INSN(pv.cmpgeu, MATCH_V_OP_CMPGEU|MATCH_V_OP)
DECLARE_INSN(pv.cmpltu, MATCH_V_OP_CMPLTU|MATCH_V_OP)
DECLARE_INSN(pv.cmpleu, MATCH_V_OP_CMPLEU|MATCH_V_OP)

DECLARE_INSN(pv.ball, MATCH_BEQM1, MASK_BEQM1)
#endif
